...
function Square({ row, col, number, possiblities }) {
    ...
    const handleDivClick = (e) => {
        ...
        if (number != -1) {
            ...
            setPuzzleContext((prevValues) => {
                return ({
                    ...prevValues, currRow: row, currCol: col,
    ...
    useEffect(() => {
        ...
        if (puzzleContext.changingNumber || puzzleContext.removingSquareNumber) {
            ...
            if ((puzzleContext.valueTypeToChange === 'normal') && ((currRow === row) || (currCol === col) || (currentBase.baseRow === baseRow && currentBase.baseCol === baseCol))) {
        ...
        if (row === puzzleContext.currRow && col === puzzleContext.currCol) {
            ...
            else if (puzzleContext.valueTypeToChange === "possibility" && puzzleContext.changingNumber && puzzleContext.numberMenuSelection != 10) {
